...
MLCLIENT_API void ml_response_delete(CResponse *t);
...
MLCLIENT_API const int ml_response_length(CResponse *t);
/// \brief Returns the response as a string. Equivalent to Response::getString
MLCLIENT_API const char* const ml_response_String(CResponse *t);
/// \brief Returns the Response Type enum value for this response
MLCLIENT_API const int ml_response_GetResponseType(CResponse *t);
/// \brief Returns the HTTP response code for this response
MLCLIENT_API const int ml_response_GetResponseCode(CResponse *t);

/// Returns the textual description for the specified response HTTP code
MLCLIENT_API const char* const ml_responsecodes_translate(int code);
