...
public:
   ...
   * web application URL.
   */
  virtual std::unique_ptr<Response> doGet(const std::string& pathAndQuerystring) = 0;
  /**
   ...
   * web application URL.
   */
  virtual std::unique_ptr<Response> doPut(const std::string& pathAndQuerystring,const IDocumentContent& payload) = 0;
  /**
   ...
   * web application URL.
   */
  virtual std::unique_ptr<Response> doPost(const std::string& pathAndQuerystring,const IDocumentContent& payload) = 0;
   ...
   * web application URL.
   */
  virtual std::unique_ptr<Response> doDelete(const std::string& pathAndQueryString) = 0;
   ...
   * \since 8.0.0
   */
  virtual std::unique_ptr<Response> getDocument(const std::string& uri) = 0; /// TODO add optional call parameters (E.g. fetch properties also)
   ...
   * \since 8.0.0
   */
  virtual std::unique_ptr<Response> saveDocument(const std::string& uri,const IDocumentContent& payload) = 0;
   ...
   * \since 8.0.0
   */
  virtual std::unique_ptr<Response> deleteDocument(const std::string& uri) = 0;
   ...
   * \since 8.0.0
   */
  virtual std::unique_ptr<Response> search(const SearchDescription& desc) = 0;
};
